...
plt.plot(loss_ita_list, label='Loss ITA (Contrastive)', color='blue', alpha=0.7)
plt.plot(loss_itm_list, label='Loss ITM (Matching)', color='green', alpha=0.9)
plt.plot(loss_lm_list, label='Loss LM (Language Model)', color='orange', alpha=0.7)
